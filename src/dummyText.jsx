// Some of dummy Text only aquired from official github docs and repo by adam-p Markdown Cheatsheet a great refrence
// Good experiment with markdown.join('\n');
...
export var dummyText = markdown.join('\n');
